...
public class ParticleToExcel {
	...
	public static void updateExcelByGeneration(ExcelGenerator excelGenerator,List<Particle> population, int interation, long totalTime) throws Exception{
		...
		excelGenerator.insertCellInfo(interation + 1, 8, Classification.getInstance().getSeed(), Cell.CELL_TYPE_NUMERIC);
